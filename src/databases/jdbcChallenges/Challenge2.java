package databases.jdbcChallenges;
...
//            addOrders(conn, orders);
    ...
    private static List<Order> readData() {
        ...
        try (Scanner scanner = new Scanner(Path.of("src/databases/jdbcChallenges/Orders.csv"))) {
                ...
                if (rs.next()) {
                    ...
                    if (orderId > -1) {
                        ...
                        if (rowsInserted != order.details().size()) {
                            throw new SQLException("Insert don't match");
                        }
                    }
                }
            }
