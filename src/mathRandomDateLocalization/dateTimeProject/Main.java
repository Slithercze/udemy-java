package mathRandomDateLocalization.dateTimeProject;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("get chronofield");
        System.out.println(May5.get(ChronoField.YEAR)); //same as May5.getDayOfYear() but using chrono
        ...
        System.out.println(May5.withYear(2000)); //changes only in print but won't mutate object
        ...
        System.out.println("----------------------");
        May5.datesUntil(May5.plusYears(1), Period.ofDays(7)) //skips by 7
                .forEach(System.out::println);
        ...
        System.out.println(sevenPM.get(ChronoField.AMPM_OF_DAY)); //returns 1 for PM and 0 for AM
