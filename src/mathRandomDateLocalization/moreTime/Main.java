package mathRandomDateLocalization.moreTime;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Period timePast2 = Period.between(LocalDate.EPOCH, dob2.toLocalDate()); //period is only for dates
        System.out.println(timePast2);

        Duration timeSince2 = Duration.between(Instant.EPOCH, dob2.toInstant(ZoneOffset.UTC)); //duration is for time
