...
public class RunMethods {
    public static void main(String[] args) {
        ...
        var c0 = new EmployeeComparator<StoreEmployee>(); //instance of employeecomparator class
        var c1 = new Employee.EmployeeComparator<StoreEmployee>(); //static nested class on employee class
        var c2 = new StoreEmployee().new StoreComparator<StoreEmployee>();//inner class store employee
