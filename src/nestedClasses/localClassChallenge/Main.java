package nestedClasses.localClassChallenge;

import nestedClasses.localClassChallenge.domain.Employee;
...
public class Main {
    ...
    public static void printOrderedList(List<Employee> eList, String sortField){
        ...
        class MyEmployee {
            Employee containtedEmployee;
            int yearsWorked;
            String fullName;

            public MyEmployee(Employee containtedEmployee) {
                this.containtedEmployee = containtedEmployee;
                yearsWorked = currentYear - Integer.parseInt(containtedEmployee.hireDate().split("/")[2]);
                fullName = String.join(" ", containtedEmployee.first(), containtedEmployee.last());
            }
