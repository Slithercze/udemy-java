...
public class MapViewsMain {
    ...
    public static void main(String[] args) {
        ...
        Set<String> keysView = contacts.keySet(); //modifies contacts
        System.out.println(keysView);

        Set<String> copyOfKeys = new TreeSet<>(contacts.keySet()); //passing into constructor doesnt modify
...
//        keysView.add("Daffy Duck"); error because adding only key and not value
//        System.out.println(contacts);
