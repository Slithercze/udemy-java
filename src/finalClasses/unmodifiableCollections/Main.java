package finalClasses.unmodifiableCollections;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Student> studentsThirdCopy = Collections.unmodifiableList(students); //returns unmodified view of backing list (reflects whats in student list) but you cant modify it
