...
public class Main {
    ...
    static {
        try (RandomAccessFile rb = new RandomAccessFile("src/FilesIO/randomAccess/student.idx", "r")) {
            loadIndex(rb, 0);
        } catch (IOException e) {
    ...
    public static void main(String[] args) {
        ...
        BuildStudentData.build("src/FilesIO/randomAccess/student", true);

        try (RandomAccessFile ra = new RandomAccessFile("src/FilesIO/randomAccess/student.dat", "r")) {
