...
public class Main {
    public static void main(String[] args) {
        ...
        printWordsConcise.accept("Let's split this up into an array"); //calling consumer
        ...
        System.out.println(everySecondChar.apply("1234567890")); //calling function
        ...
        System.out.println(iLoveJava.get()); //calling supplier
