...
//        List<String> firstOnes = bingoPool.subList(0,15); backed by view (means it will modify original list)
...
//                .forEach(System.out::println);
        ...
        IntStream.iterate(1, n -> n + 1)
                .filter(Main::isPrime)
                .limit(20) //first 20 prime nums
                .forEach(s -> System.out.print(s + " "));

        System.out.println();
        IntStream.iterate(1, n -> n + 1)
                .limit(100) //first prime nums that are less than 100
                .filter(Main::isPrime)
                .forEach(s -> System.out.print(s + " "));
