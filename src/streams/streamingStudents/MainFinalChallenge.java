...
public class MainFinalChallenge {
    ...
    public static void main(String[] args) {
        ...
        //how many students are taking 1, 2, 3 classes
        System.out.println(students
                .stream()
                .mapToInt(s -> s.getEngagementMap().size())
                .summaryStatistics());

        //average percentage complete, for all courses for this group of students
        ...
        var yearMap = students.stream()
                .flatMap(s -> s.getEngagementMap().values().stream())
                .collect(Collectors.groupingBy(CourseEngagement::getCourseCode, //key, value
