...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        IntStream.iterate((int) 'A', i -> i <= (int) 'z', i -> i + 1)
                ...
                .distinct()
//                .dropWhile(i -> Character.toUpperCase(i) <= 'E') //once condition is false its no longer checked
//                .takeWhile(i -> i < 'a')
//                .skip(5)
//                .filter(i -> Character.toUpperCase(i) < 'E')
        ...
        var stream = Stream.iterate(0, i -> i < maxSeats, i -> i + 1)
                ...
                .skip(5)
                .limit(10)
                .peek(s -> System.out.println("--> " + s)) //mostly used for debugging (it won't print without terminal operation)
